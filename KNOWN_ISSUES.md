...
| Der letzte Desktop-Build auf `main` scheitert reproduzierbar im Windows-AppContainer-Selbsttest: Der PyInstaller-Runner kann sein eingebettetes PKG-Archiv im Container nicht erneut lesen. Build und direkter Start der EXE sowie Linux und beide macOS-Architekturen sind erfolgreich. | Der Workflow erzeugt kein neues vollständiges 0.7-Artefaktset; die vorhandene 0.7.0-Veröffentlichung bleibt verfügbar. Der integrierte Windows-Start gilt bis zur erneuten Prüfung nicht als für 0.8 freigegeben. | Vorhandenes 0.7.0-Release verwenden; den fehlerhaften CI-Lauf nicht als neues Release behandeln. | ACL-/Startpfad im 0.8-Branch härten und AppContainer-Selbsttest sowie echten Windows-Gerätetest vor `v0.8.0` bestehen. |
| Vier browsergestützte NiceGUI-E2E-Prüfungen sind vom normalen Testlauf und der aktuellen CI getrennt. | Der normale Lauf bleibt schnell und reproduzierbar, deckt den vollständigen Browserweg aber nicht ab. Lokal bestehen am 23. August 2026 alle vier Prüfungen; in eingeschränkten Umgebungen können Prozess-Semaphoren fehlen. | E2E-Prüfungen mit `pytest -m e2e` in einer geeigneten lokalen Umgebung ausführen. | Den grünen lokalen Stand vor der 0.8-Freigabe im CI-/Releaseablauf bestätigen. |
